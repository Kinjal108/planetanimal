...
class GenresController extends MainAdminController
{
    ...
    public function genres_list()    { 
        ...
        $genres_list = Genres::orderBy('genre_name')->paginate(8);
         
        return view('admin.pages.genres.list',compact('page_title','genres_list'));
    }
    ...
    { 
        ...
        if(!empty($inputs['id'])){
         ...
         $genre_slug = Str::slug($inputs['genre_name'], '-',null);
