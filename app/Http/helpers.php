...
use App\Models\UsersDeviceHistory;
...
if (! function_exists(function: 'removeFile')) {
...
if (! function_exists('set_tmdb_language')) {
    ...
    { 
        if(getcong('tmdb_api_language'))
        {
            $default_language=getcong('tmdb_api_language');
        }
        else
        {
...
if (! function_exists('share_url_get')) {
    ...
    function share_url_get($type,$slug,$id)
    {
        ...
        {
            $share_url= \URL::to('earthling/details/'.$slug.'/'.$id);
        } 
        else
        {
