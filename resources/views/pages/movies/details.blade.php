  ...
  <div class="container-fluid">
    ...
    <div class="detail-poster-area">
     ...
     <div class="play-icon-item">
      ...
      <div class="dtl-poster-img">
        <img src="{{URL::to('public/'.$movies_info->video_image)}}" alt="{{stripslashes($movies_info->video_title)}}" title="{{stripslashes($movies_info->video_title)}}" />
      </div>
    </div>
    </div>
    <div class="col-lg-5 col-md-12 col-sm-12 col-xs-12 mb-4"> 
      ...
      <ul class="dtl-list-link">
        ...
        @endforeach  
        <li>
          <a href="{{ URL::to('movies?lang_id='.$movies_info->movie_lang_id) }}" title="{{App\Models\Language::getLanguageInfo($movies_info->movie_lang_id,'language_name')}}">{{App\Models\Language::getLanguageInfo($movies_info->movie_lang_id,'language_name')}}</a>
        </li>
