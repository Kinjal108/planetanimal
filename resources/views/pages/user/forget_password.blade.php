    ...
    <div class="row g-0 min-vh-100 overflow-hidden"> 
      ...
      <div class="col-md-12">
        <div class="hero-wrap d-flex align-items-center h-100">
          ...
          <div class="hero-bg hero-bg-scroll" style="background-image:url('{{ URL::asset('public/site_assets/images/login-signup-bg-img.jpg') }}');"></div>
              ...
              <div class="col-12 col-lg-5 col-xl-5 mx-auto">
                <div class="logo mt-40 mb-20 mb-md-0 justify-content-center d-flex text-center"> 
                  @if(getcong('site_logo'))                 
                    <a href="{{ URL::to('/') }}" title="logo" class="d-flex"><img src="{{ URL::asset('public/'.getcong('site_logo')) }}" alt="logo" title="logo" class="login-signup-logo"></a>
                  @else
                    <a href="{{ URL::to('/') }}" title="logo" class="d-flex"><img src="{{ URL::asset('public/site_assets/images/logo.png') }}" alt="logo" title="logo" class="login-signup-logo"></a>                          
                  @endif
                </div>
              </div>
            </div>
