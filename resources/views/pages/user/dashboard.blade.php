        ...
        <div class="row">
          ...
          <div class="img-profile"> 
            @if(Auth::User()->user_image)
              <img src="{{ URL::asset('public/upload/'.Auth::User()->user_image) }}" class="img-rounded" alt="profile pic" title="profile pic">
            @else  
              <img src="{{ URL::asset('public/site_assets/images/user-avatar.png') }}" class="img-rounded" alt="profile_img" title="profile pic">
            @endif
