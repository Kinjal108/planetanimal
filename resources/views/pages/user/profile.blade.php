            ...
            <div class="user_pic_view">          
              <div class="fileupload_img">
                @if(Auth::User()->user_image)
                  <img class="fileupload_img" src="{{ URL::asset('public/upload/'.Auth::User()->user_image) }}"  alt="profile pic" title="profile pic">
                @else  
                <img class="fileupload_img" src="{{ URL::asset('public/site_assets/images/user-avatar.png') }}" alt="profile pic" title="profile pic">
                @endif
              </div>           
            </div>
          </div>
