...
@section('head_title', trans('words.earthling_text').' | '.getcong('site_name') )
...
<link rel="stylesheet" href="{{ URL::asset('public/site_assets/css/nice-select.css') }}">
...
<div class="view-all-video-area vfx-item-ptb">
  <div class="container-fluid">
   <div class="filter-list-area">
    <div class="row">
      <div class="col-lg-12">
        <!-- <div class="page-title-item">{{trans('words.earthling_text')}}</div>        -->
    ...
    <div class="row">
         ...
         <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 col-6">
          <div class="single-video">
            <a href="{{ URL::to('earthling/details/'.$sports_video->video_slug.'/'.$sports_video->id) }}" title="{{$sports_video->video_title}}">
               <div class="video-img">          
                ...
                <img src="{{URL::to('public/'.$sports_video->video_image)}}" title="{{$sports_video->video_title}}" alt="{{$sports_video->video_title}}">         
               </div>
