  ...
  <div class="container-fluid">
    ...
    <div class="col-lg-5 col-md-12 col-sm-12 col-xs-12 mb-4"> 
      ...
      <ul class="dtl-list-link">
        ...
        <li><a href="{{ URL::to('public/earthling/?cat_id='.$sports_info->sports_cat_id) }}" title="{{App\Models\SportsCategory::getSportsCategoryInfo($sports_info->sports_cat_id,'category_name')}}">{{App\Models\SportsCategory::getSportsCategoryInfo($sports_info->sports_cat_id,'category_name')}}</a></li>
