      ...
      <div class="col-lg-12">
        ...
        <div class="custom_select_filter">
          <select class="selectpicker show-menu-arrow" id="filter_by_lang">
            ...
            @foreach(\App\Models\TvCategory::where('status','1')->orderBy('id')->get() as $cat_data)
          ...
          <div class="single-video">
            <a href="{{ URL::to('livetv/details/'.$live_tv_data->channel_slug.'/'.$live_tv_data->id) }}" title="{{$live_tv_data->channel_name}}">
               <div class="video-img">          
                ...
                <img src="{{URL::to('public/'.$live_tv_data->channel_thumb)}}" title="{{$live_tv_data->channel_name}}" alt="{{$live_tv_data->channel_name}}">         
               </div>
