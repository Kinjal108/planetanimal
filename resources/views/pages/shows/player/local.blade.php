 ...
 <script type="text/javascript">
			 FWDEVPUtils.onReady(function(){
				 ...
				 new FWDEVPlayer({		
					 ...
					 mainFolderPath:"{{URL::asset('public/site_assets/player/content/')}}",
					 ...
					 stopAtTime:"",
					 videoSource:[
						 {source:"encrypt:{{base64_encode(URL::to('public/'.$episode_info->video_url))}}", label:"default"},
						 
						  
						 @if($episode_info->video_quality)
						 @if($episode_info->video_url_480)
						 {source:"encrypt:{{base64_encode(URL::to('public/'.$episode_info->video_url_480))}}", label:"480"},
						 @endif	
							 
						 @if($episode_info->video_url_720)	
						 {source:"encrypt:{{base64_encode(URL::to('public/'.$episode_info->video_url_720))}}", label:"720"},
						 @endif	
							 
						 @if($episode_info->video_url_1080)	
						 {source:"encrypt:{{base64_encode(URL::to('public/'.$episode_info->video_url_1080))}}", label:"1080"}
						 @endif	  
						 @endif
					 ],
					 posterPath:"{{URL::to('public/'.$episode_info->video_image)}}",
					 showErrorInfo:"yes",
					 ...
					 //logo settings
					 logoSource:"{{ get_player_cong('player_logo')? URL::asset('public/'.get_player_cong('player_logo')) : URL::asset('public/'.getcong('site_logo')) }}",
					 ...
					 mainBackgroundImagePath:"{{URL::asset('public/site_assets/player/content/minimal_skin_dark/main-background.png')}}",
