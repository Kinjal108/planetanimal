      ...
      <div class="col-lg-12 col-md-12 col-sm-12">
        ...
        @if($sports_info->video_url!="")
          ...
          @if($sports_info->video_type=="Embed")
              ...
              @include("pages.earthling.player.embed")

          @elseif($sports_info->video_type=="Local")

              @include("pages.earthling.player.local")           

          @elseif($sports_info->video_type=="URL")

              @include("pages.earthling.player.url")

          @else

              @include("pages.earthling.player.other")
    ...
    <div class="row">
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"> 
        ...
        <ul class="actor-video-link">           
          <li><a href="{{ URL::to('sports/?cat_id='.$sports_info->sports_cat_id) }}" title="{{App\Models\Earthling_category::getSportsCategoryInfo($sports_info->sports_cat_id,'category_name')}}">{{App\Models\Earthling_category::getSportsCategoryInfo($sports_info->sports_cat_id,'category_name')}}</a></li>           
        </ul>
