    ...
    <div class="footer-wrapper">
      ...
      @endif
        ...
        <div class="footer-links">
          <ul>
          @foreach(\App\Models\Pages::where('status','1')->orderBy('page_order')->get() as $page_data)
...
@if(getcong('footer_fb_link') || getcong('footer_twitter_link') || getcong('footer_instagram_link'))

    @if(getcong('footer_google_play_link') == "" && getcong('footer_apple_store_link') == "")
            ...
            <div class="social-links">
                <ul>
                    @if(getcong('footer_fb_link'))
                        <li>
                            <a href="{{ stripslashes(getcong('footer_fb_link')) }}" title="facebook">
                    ...
                    @if(getcong('footer_twitter_link'))
                        <li>
                            <a href="{{ stripslashes(getcong('footer_twitter_link')) }}" title="twitter">
                    ...
                    @if(getcong('footer_instagram_link'))
                        <li>
                            <a href="{{ stripslashes(getcong('footer_instagram_link')) }}" title="instagram">
          ...
          <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
            <div class="single-footer">
              ...
              <div class="download-app-link-item"> 
                ...
                <a class="google-play-download" href="{{stripslashes(getcong('footer_google_play_link'))}}" target="_blank" title="Google Play"><img src="{{ URL::asset('public/site_assets/images/google-play.png') }}" alt="Google Play Download" title="Google Play Download"></a> 
                @endif

                @if(getcong('footer_apple_store_link'))  
                <a class="apple-store-download" href="{{stripslashes(getcong('footer_apple_store_link'))}}" target="_blank" title="Apple Store"><img src="{{ URL::asset('public/site_assets/images/app-store.png') }}" alt="Apple Store Download" title="Apple Store Download"></a>
                @endif 
              </div>
            </div>
          </div> 
