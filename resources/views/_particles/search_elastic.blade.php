          ...
          <div class="video-carousel owl-carousel">
            ...
            <a href="{{ URL::to('movies/details/'.$movies_data->video_slug.'/'.$movies_data->id) }}">
               <div class="video-img">
                ...
                <img src="{{URL::to('public/'.$movies_data->video_image_thumb)}}" alt="{{$movies_data->video_title}}" title="{{$movies_data->video_title}}">         
               </div>       
            </a>
            </div>
            @endforeach
        ...
        <div class="video-shows-carousel owl-carousel">
          ...
          <a href="{{ URL::to('shows/details/'.$series_data->series_slug.'/'.$series_data->id) }}">
             <div class="video-img">          
              ...
              <img src="{{URL::to('public/'.$series_data->series_poster)}}" alt="{{$series_data->series_name}}" title="{{$series_data->series_name}}">         
             </div>       
          </a>
          </div>
          @endforeach
    ...
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="tv-season-video-carousel owl-carousel">
          ...
          <div class="single-video">
          <a href="{{ URL::to('earthling/details/'.$sports_video->video_slug.'/'.$sports_video->id) }}">
             <div class="video-img">          
              ...
              <img src="{{URL::to('public/'.$sports_video->video_image)}}" alt="{{$sports_video->video_title}}" title="{{$sports_video->video_title}}">         
             </div>       
          </a>
          </div>
          @endforeach
        ...
        <div class="tv-season-video-carousel owl-carousel">
          ...
          <a href="{{ URL::to('livetv/details/'.$live_tv_data->channel_slug.'/'.$live_tv_data->id) }}">
             <div class="video-img">          
              ...
              <img src="{{URL::to('public/'.$live_tv_data->channel_thumb)}}" alt="{{$live_tv_data->channel_name}}" title="{{$live_tv_data->channel_name}}">         
             </div>       
          </a>
          </div>
          @endforeach
