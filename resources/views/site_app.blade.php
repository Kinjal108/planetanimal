...
<meta property="og:image" content="@yield('head_image', URL::asset('public/'.getcong('site_logo')))" />
<meta property="og:url" content="@yield('head_url', url('/'))" />
<meta property="og:image:width" content="1024" />
<meta property="og:image:height" content="1024" />
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:image" content="@yield('head_image', URL::asset('public/'.getcong('site_logo')))">
<link rel="image_src" href="@yield('head_image', URL::asset('public/'.getcong('site_logo')))">

<!-- Favicon -->
<link rel="icon" href="{{ URL::asset('public/'.getcong('site_favicon')) }}">

  
<!-- LOAD LOCAL CSS -->
<link rel="stylesheet" href="{{ URL::asset('public/site_assets/css/bootstrap.min.css') }}">
<link rel="stylesheet" href="{{ URL::asset('public/site_assets/css/owl.carousel.min.css') }}">
 
<link rel="stylesheet" href="{{ URL::asset('public/site_assets/css/megamenu.css') }}">
<link rel="stylesheet" href="{{ URL::asset('public/site_assets/css/ionicons.css') }}">
<link rel="stylesheet" href="{{ URL::asset('public/site_assets/css/font-awesome.min.css') }}">
 
   
<link rel="stylesheet" href="{{ URL::asset('public/site_assets/css/color-style/'.getcong('styling').'.css') }}" id="theme">

<link rel="stylesheet" href="{{ URL::asset('public/site_assets/css/responsive.css') }}">

<!-- Splide Slider CSS -->
<link rel="stylesheet" href="{{ URL::asset('public/site_assets/css/splide.min.css') }}">

<link rel="stylesheet" href="{{ URL::asset('public/site_assets/css/jquery-eu-cookie-law-popup.css') }}">

<!-- SweetAlert2 -->
<script src="{{ URL::asset('public/site_assets/js/sweetalert2@11.js') }}"></script>
...
<div class="eupopup eupopup-bottom"></div>
  ...
  <!-- Load Local JS --> 
<script src="{{ URL::asset('public/site_assets/js/jquery-3.3.1.min.js') }}"></script> 
<script src="{{ URL::asset('public/site_assets/js/jquery.easing.min.js') }}"></script> 
<script src="{{ URL::asset('public/site_assets/js/bootstrap.min.js') }}"></script> 
<script src="{{ URL::asset('public/site_assets/js/owl.carousel.min.js') }}"></script>
<script src="{{ URL::asset('public/site_assets/js/jquery.nice-select.min.js') }}"></script>  
<script src="{{ URL::asset('public/site_assets/js/megamenu.js') }}"></script> 

 
<!-- Splide Slider JS -->
<script src="{{ URL::asset('public/site_assets/js/splide.min.js') }}"></script>

<!-- Custom Main JS -->
<script src="{{ URL::asset('public/site_assets/js/custom-main.js') }}"></script>


<script src="{{ URL::asset('public/site_assets/js/jquery-eu-cookie-law-popup.js') }}"></script> 
...
function showSuggestions(inputString) {
  if(inputString.length <= 1){
    ...
    $.ajax({
      ...
      dataType:'text',
      beforeSend: function(){
      $("#search_box").css("background","{{$search_bg}} url({{ URL::asset('public/site_assets/images/LoaderIcon.gif') }}) no-repeat 100%");
      },
