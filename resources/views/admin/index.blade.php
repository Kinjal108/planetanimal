  ...
  <div class="wrapper-page">
    <div class="text-center">
      ...
      @if(getcong('site_logo'))
        <a class="navbar-brand" href="{{ URL::to('/') }}" target="_blank"> <img src="{{ URL::asset('public/'.getcong('site_logo')) }}" alt="Site Logo" width="150"> </a> 
      @else
        <a class="navbar-brand" href="{{ URL::to('/') }}" target="_blank"> <img src="{{ URL::asset('public/site_assets/images/logo.png') }}" alt="Site Logo"> </a>          
      @endif
