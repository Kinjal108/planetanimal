                    ...
                    <div class="col-lg-2 col-md-3 col-sm-3 col-xs-6" id="card_box_id_{{$data->id}}">
                        ...
                        <div class="card m-b-20">
                            <div class="wall-list-item">
                              ...
                              @if(isset($data->ad_image)) <img class="card-img-top thumb-xs img-fluid" src="{{URL::to('public/'.$data->ad_image)}}" alt="{{ stripslashes($data->ad_name) }}">
                              @else
                              <img class="card-img-top thumb-xs img-fluid" src="{{URL::to('public/admin_assets/images/placeholder.png')}}" alt="{{ stripslashes($data->ad_name) }}">
                              @endif
                            </div>
