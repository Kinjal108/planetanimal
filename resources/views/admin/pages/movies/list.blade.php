                    ...
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-6" id="card_box_id_{{$movies->id}}">
                        ...
                        <div class="card m-b-20">
                            <div class="wall-list-item">
                              ...
                              <p class="wall_sub_text">{{ \App\Models\Language::getLanguageInfo($movies->movie_lang_id,'language_name') }}</p>
                               
                              @if(isset($movies->video_image_thumb)) <img class="card-img-top thumb-xs img-fluid" src="{{URL::to('public/'.$movies->video_image_thumb)}}" alt="{{ stripslashes($movies->video_title) }}"> @endif
                            </div>
