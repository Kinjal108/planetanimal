                ...
                <div class="row">
                 ...
                 {!! Form::open(array('url' => array('admin/general_settings'),'class'=>'form-horizontal','name'=>'settings_form','id'=>'settings_form','role'=>'form','enctype' => 'multipart/form-data')) !!}  
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">                                                                         
                      <img src="{{URL::to('public/'.$settings->site_logo)}}" alt="video image" class="img-thumbnail" width="160">                                               
                    </div>
                  </div>
                  @endif
                  ...
                  <div class="form-group row">
                    <label class="col-sm-3 col-form-label">&nbsp;</label>
                    <div class="col-sm-8">                                                                         
                      <img src="{{URL::to('public/'.$settings->site_favicon)}}" alt="video image" class="img-thumbnail" width="32">                                               
                    </div>
                  </div>
                  @endif
