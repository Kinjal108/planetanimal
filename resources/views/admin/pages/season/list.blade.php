                  ...
                  @foreach($season_list as $i => $season)
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-6" id="card_box_id_{{$season->id}}">
                        ...
                        <div class="card m-b-20">
                            ...
                            @if(isset($season->season_poster)) <img class="card-img-top thumb-xs img-fluid" src="{{URL::to('public/'.$season->season_poster)}}" alt="{{ stripslashes($season->season_name) }}"> @endif
