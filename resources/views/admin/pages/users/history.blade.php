                            ...
                            <div class="col-sm-8">
                                <div class="bg-picture card-box">
                                    ...
                                    <div class="profile-info-name">
                                        ...
                                        @if($user->user_image)
                                          <img src="{{ URL::asset('public/upload/'.$user->user_image) }}" class="img-thumbnail" alt="profile_img" style="width: 155px">
                                        @else  
                                          <img src="{{ URL::asset('public/upload/profile.jpg') }}" class="img-thumbnail" alt="profile_img" style="width: 155px">
                                        @endif
                                    ...
                                    <ul class="list-group m-b-0 user-list">
                                        <li class="list-group-item">
                                            <a href="#" class="user-list-item">
                                                ...
                                                <div class="user-desc">
                                                    <span class="name">{{\App\Models\SubscriptionPlan::getSubscriptionPlanInfo($user->plan_id,'plan_name')}}</span>
                                  ...
                                  <tbody>
                                   @foreach($transactions_list as $i => $transaction_data)
                                    <tr>
                                      ...
                                      <td>{{\App\Models\SubscriptionPlan::getSubscriptionPlanInfo($transaction_data->plan_id,'plan_name')}}</td>
