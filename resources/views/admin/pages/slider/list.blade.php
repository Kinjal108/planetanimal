                  ...
                  @foreach($slider_list as $i => $slider)
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6" id="card_box_id_{{$slider->id}}">
                        ...
                        <div class="card m-b-20 slider-img-item">
                            ...
                            @if(isset($slider->slider_image)) <img class="card-img-top thumb-lg img-fluid" src="{{URL::to('public/'.$slider->slider_image)}}" alt="{{ stripslashes($slider->slider_title) }}"> @endif
