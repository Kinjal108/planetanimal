                    ...
                    <div class="col-xl-3 col-md-6">
                        ...
                        <div class="card-box widget-user">
                            <div class="text-center">
                                ...
                                <h5 style="color: #f9f9f9;">{{trans('words.earthling_text')}}</h5>
                            </div>
                        </div>
                        </a>
                    </div>
...
<!--Morris Chart-->
    <script src="{{ URL::asset('public/admin_assets/plugins/morris/morris.min.js') }}"></script>
    <script src="{{ URL::asset('public/admin_assets/plugins/raphael/raphael-min.js') }}"></script>
