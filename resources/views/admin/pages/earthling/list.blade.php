            ...
            <div class="col-12">
              <div class="card-box table-responsive">
                ...
                <div class="row">
                  ...
                  <div class="col-md-3">
                     {!! Form::open(array('url' => 'admin/earthling','class'=>'app-search','id'=>'search','role'=>'form','method'=>'get')) !!}   
                ...
                <div class="col-md-3">
                  <a href="{{URL::to('admin/earthling/add_video')}}" class="btn btn-success btn-md waves-effect waves-light m-b-20 mt-2 pull-right" data-toggle="tooltip" title="{{trans('words.add_video')}}"><i class="fa fa-plus"></i> {{trans('words.add_video')}}</a>
                </div>
              </div>
                  ...
                  @foreach($video_list as $i => $video_data)
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-6" id="card_box_id_{{$video_data->id}}">
                        ...
                        <div class="card m-b-20">
                            ...
                            @if(isset($video_data->video_image)) <img class="card-img-top thumb-lg img-fluid" src="{{URL::to('public/'.$video_data->video_image)}}" alt="{{ stripslashes($video_data->video_title) }}"> @endif
 

                            <div class="card-body p-3">
                                <h4 class="card-title mb-3">{{ stripslashes($video_data->video_title) }}</h4>
                                <a href="{{ url('admin/earthling/edit_video/'.$video_data->id) }}" class="btn btn-icon waves-effect waves-light btn-success m-r-5" data-toggle="tooltip" title="{{trans('words.edit')}}"> <i class="fa fa-edit"></i> </a>
