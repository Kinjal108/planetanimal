                  ...
                  @foreach($live_tv_list as $i => $live_tv_data)
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-6" id="card_box_id_{{$live_tv_data->id}}">
                        ...
                        <div class="card m-b-20">
                            ...
                            @if(isset($live_tv_data->channel_thumb)) <img class="card-img-top thumb-lg img-fluid" src="{{URL::to('public/'.$live_tv_data->channel_thumb)}}" alt="{{ stripslashes($live_tv_data->channel_name) }}"> @endif
