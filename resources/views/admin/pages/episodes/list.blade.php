                  ...
                  @foreach($episodes_list as $i => $episodes)
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-6" id="card_box_id_{{$episodes->id}}">
                        ...
                        <div class="card m-b-20">
                            ...
                            @if(isset($episodes->video_image)) <img class="card-img-top thumb-lg img-fluid" src="{{URL::to('public/'.$episodes->video_image)}}" alt="{{ stripslashes($episodes->video_title) }}"> @endif
