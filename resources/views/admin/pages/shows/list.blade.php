                  ...
                  @foreach($series_list as $i => $series)
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-6" id="card_box_id_{{$series->id}}">
                        ...
                        <div class="card m-b-20">
                            ...
                            @if(isset($series->series_poster)) <img class="card-series-img thumb-xs img-fluid" src="{{URL::to('public/'.$series->series_poster)}}" alt="{{ stripslashes($series->series_name) }}"> @endif
