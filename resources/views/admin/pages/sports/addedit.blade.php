          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="card-box">
                ...
                <div class="row">
                     <div class="col-sm-6">
                          <a href="{{ URL::to('admin/earthling') }}"><h4 class="header-title m-t-0 m-b-30 text-primary pull-left" style="font-size: 20px;"><i class="fa fa-arrow-left"></i> {{trans('words.back')}}</h4></a>
                     </div>
                     @if(isset($video_info->id))
                     <div class="col-sm-6">
                        <a href="{{ URL::to('earthling/details/'.$video_info->video_slug.'/'.$video_info->id) }}" target="_blank"><h4 class="header-title m-t-0 m-b-30 text-primary pull-right" style="font-size: 20px;">{{trans('words.preview')}} <i class="fa fa-eye"></i></h4> </a>
                     </div>
                     @endif
                   </div>
                 ...
                 {!! Form::open(array('url' => array('admin/earthling/add_edit_video'),'class'=>'form-horizontal','name'=>'video_form','id'=>'video_form','role'=>'form','enctype' => 'multipart/form-data')) !!}  
                  ...
                  <div class="form-group row">
                    <label class="col-sm-3 col-form-label">{{trans('words.earthling_cat_text')}} *</label>
                      <div class="col-sm-8">
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <img src="{{URL::to('public/'.$video_info->video_image)}}" alt="video image" class="img-thumbnail" width="200"> 
                    </div>
                  </div>
                  @endif
