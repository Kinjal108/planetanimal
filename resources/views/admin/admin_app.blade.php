...
<head>
  ...
  <link rel="shortcut icon" href="{{ URL::asset('public/'.getcong('site_favicon')) }}">
  @else
  <link rel="shortcut icon" href="{{ URL::asset('public/site_assets/images/favicon.png') }}">
  @endif
  <title>{{getcong('site_name')}} Admin</title>

  <!--Morris Chart CSS -->
 <link rel="stylesheet" href="{{ URL::asset('public/admin_assets/plugins/morris/morris.css') }}">

 
     <link href="{{ URL::asset('public/admin_assets/css/bootstrap.min.css') }}" rel="stylesheet" type="text/css" />
     <link href="{{ URL::asset('public/admin_assets/css/icons.css') }}" rel="stylesheet" type="text/css" />
     <link href="{{ URL::asset('public/admin_assets/plugins/multiselect/css/multi-select.css') }}" rel="stylesheet" type="text/css" />
     <link href="{{ URL::asset('public/admin_assets/plugins/select2/css/select2.min.css') }}" rel="stylesheet" type="text/css" />
     <link href="{{ URL::asset('public/admin_assets/plugins/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css') }}" rel="stylesheet">

     <link href="{{ URL::asset('public/admin_assets/plugins/switchery/switchery.min.css') }}" rel="stylesheet">

     <link href="{{ URL::asset('public/admin_assets/css/style.css') }}" rel="stylesheet" type="text/css" />
      <link href="{{ URL::asset('public/admin_assets/css/font-awesome.min.css') }}" rel="stylesheet" type="text/css" />  

     <script src="{{ URL::asset('public/admin_assets/js/modernizr.min.js') }}"></script>
 

  <!-- App css -->
 
  <!-- SweetAlert2 -->
  <script src="{{ URL::asset('public/admin_assets/js/sweetalert2@11.js') }}"></script>
  ...
  <script src="{{ URL::asset('public/admin_assets/js/detect.js') }}"></script>
  <script src="{{ URL::asset('public/admin_assets/js/fastclick.js') }}"></script>
  <script src="{{ URL::asset('public/admin_assets/js/jquery.blockUI.js') }}"></script>
  <script src="{{ URL::asset('public/admin_assets/js/waves.js') }}"></script>
  <script src="{{ URL::asset('public/admin_assets/js/jquery.nicescroll.js') }}"></script>
  <script src="{{ URL::asset('public/admin_assets/js/jquery.slimscroll.js') }}"></script>
  <script src="{{ URL::asset('public/admin_assets/js/jquery.scrollTo.min.js') }}"></script>
  <script src="{{ URL::asset('public/admin_assets/plugins/switchery/switchery.min.js') }}"></script>
  <script src="{{ URL::asset('public/admin_assets/plugins/tinymce/tinymce.min.js') }}"></script>
  

  <script src="{{ URL::asset('public/admin_assets/plugins/jquery-knob/jquery.knob.js') }}"></script>
  <script src="{{ URL::asset('public/admin_assets/plugins/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js') }}"></script>
 
  <script type="text/javascript" src="{{ URL::asset('public/admin_assets/plugins/multiselect/js/jquery.multi-select.js') }}"></script>
  <script src="{{ URL::asset('public/admin_assets/plugins/select2/js/select2.min.js') }}" type="text/javascript"></script>
  
  @if(classActivePath('dashboard'))
  <!-- Counter Up  -->
  <script src="{{ URL::asset('public/admin_assets/plugins/waypoints/jquery.waypoints.min.js') }}"></script>
  <script src="{{ URL::asset('public/admin_assets/plugins/counterup/jquery.counterup.min.js') }}"></script>
  @endif

  <!-- App js -->
   <script src="{{ URL::asset('public/admin_assets/js/jquery.core.js') }}"></script>
   <script src="{{ URL::asset('public/admin_assets/js/jquery.app.js') }}"></script>
...
<link rel="stylesheet" href="{{url('public/packages')}}/barryvdh/elfinder/css/colorbox.css">

 
<script src="{{url('public/packages')}}/barryvdh/elfinder/js/jquery.colorbox.js"></script>
<script type="text/javascript" src="{{url('public/packages')}}/barryvdh/elfinder/js/jquery.colorbox-min.js"></script>
