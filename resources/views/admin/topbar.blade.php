      ...
      <div class="topbar-left"> 
        <a href="{{ URL::to('admin/dashboard') }}" class="logo">
          <span>
            ...
            <img src="{{ URL::asset('public/'.getcong('site_logo')) }}" alt="Site Logo" width="120">
            @else
            <img src="{{ URL::asset('public/site_assets/images/logo.png') }}" alt="Site Logo" width="120">           
            @endif
          </span>
            ...
            <ul class="list-unstyled topbar-right-menu float-right mb-0">
              ...
              <li class="dropdown notification-list">
                <a class="nav-link dropdown-toggle waves-effect waves-light nav-user" data-toggle="dropdown" href="#"
                  ...
                  @if(file_exists(public_path('public/upload/'.Auth::user()->user_image)))                                 
 
                  <img src="{{URL::to('public/upload/'.Auth::user()->user_image)}}" alt="person" class="rounded-circle" />
                  
                  @else
                      
                  <img src="{{ URL::asset('public/admin_assets/images/users/avatar-10.jpg') }}" alt="person" class="rounded-circle" />
