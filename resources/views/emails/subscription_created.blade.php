...
<tbody>
<tr>
<td><a href="{{ url('/') }}" target="_blank"><img style="border:0;display:block;outline:none;text-decoration:none;height:auto;min-width: 20%;width: 20%;max-width: 100%;font-size: 13px;margin: 0 auto;padding: 25px;" src="{{ URL::asset('public/'.getcong('site_logo')) }}" width="200" height="25" style="width:200px;height:25px"></a></td> 
</tr>
</tbody>
</table>
</td>
